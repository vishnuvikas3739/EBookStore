...
public class BookDAOImpl implements BookDAO {
	...
	public boolean addBooks(BookDtls b) {
		boolean f=false;
		try {
			String sql="insert into book_dtls(bookname,author,price,bookCategory,status,photo,email,rating,display) values(?,?,?,?,?,?,?,?,?)";
			...
			ps.setString(8, b.getRating());
			ps.setString(9, b.getDisplay());
	...
	public List<BookDtls> getAllBooks() {
		...
		try {
			...
			while(rs.next())
			{
                ...
                b.setRating(rs.getString(9));
                b.setDisplay(rs.getString(10));
